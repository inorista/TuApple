        		...
        		@csrf
					...
					<div class="flex-sb-m w-full p-b-48">
						<div class="contact100-form-checkbox">
              					<a href="signup" class="txt3"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;&nbsp;Chưa có tài khoản? Đăng ký ngay !</a>
						</div>
					</div>

					<div class="container-login100-form-btn">
            			<input class="login100-form-btn" type="submit" name="btnSubmit" value="LOGIN" /></input>
					</div>
				</form>
			</div>
		</div>
